# nvim-treesitter-queries-rnoweb

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rnoweb/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rnoweb/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rnoweb**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rnoweb",
...
- [ ] Changes are scoped to `rnoweb` — do not include files for other languages
